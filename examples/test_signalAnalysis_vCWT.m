...
for current_frame=frames_to_show
    ...
    [cfs1, ~] = cwt(S, 'morse', Fs, 'FrequencyLimit', [5.3e6, 5.6e6], 'VoicesPerOctave', 48);
    [cfs2, ~] = cwt(S, 'morse', Fs, 'FrequencyLimit', [7.0e6, 7.3e6], 'VoicesPerOctave', 48);
    ...
    yyaxis(ax_cwt,'right');
    plot(ax_cwt, t_vector, S_envelope, '-', 'Color', 'g', 'Tag', 'plot_cwt');
    yyaxis(ax_cwt,'left');
